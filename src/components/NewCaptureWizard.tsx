...
export const NewCaptureWizard: React.FC<NewCaptureWizardProps> = ({
  ...
  const toggleScingGPT = useCallback(() => {
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-gradient-to-br from-gray-900 to-slate-800 rounded-xl shadow-2xl border border-gray-700/50 w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col"
