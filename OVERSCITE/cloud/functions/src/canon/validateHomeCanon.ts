...
import { OVERSCITE_HOME_CANON } from './oversciteHomeCanon';

// A simple, partial type definition for the canon.
...
interface Canon {
  ...
  inspection_structure: {
    metadata_required: readonly string[];
  };
  domains: Record<string, any>;
  ancillary_modules: Record<string, any>;
}

export function validateHomeCanon() {
  const canon: Canon = OVERSCITE_HOME_CANON;
