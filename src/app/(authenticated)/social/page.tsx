  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      />
        ...
        {/* Truthfulness Banner */}
        <Alert className="bg-pro/5 border-pro/20">
            <Info className="h-4 w-4 text-pro" />
            <AlertTitle className="text-pro font-bold text-xs">SOCIAL_CORE_UNDER_EXTENSION</AlertTitle>
            <AlertDescription className="text-[11px] text-muted-foreground">
                In-feed mutations and direct social broadcasting are locked during the Tier 4 Rollout. 
                Surface is operating in **Audit-Only** mode for historical context and intelligence consumption.
            </AlertDescription>
        </Alert>

        <div className="grid grid-cols-1 md:grid-cols-[1fr_320px] gap-8 items-start">
            <div className="space-y-6">
                 <Card className="bg-card/40 backdrop-blur-sm border-border/50 opacity-60">
                    <CardHeader className="flex-row items-center gap-4">
                        ...
                        <div className="flex-1">
                            <Input placeholder="Broadcasting locked..." disabled className="bg-muted/50 border-none cursor-not-allowed" />
                        </div>
                    </CardHeader>
                ...
                <div className="flex items-center gap-2">
                    <div className="relative flex-1">
                        ...
                        <Input placeholder="Search timeline..." className="pl-9 rounded-full bg-card/40 border-border/50" />
                    </div>
                </div>
                    ...
                    <Card key={post.id} className="bg-card/40 backdrop-blur-sm border-border/50 group hover:bg-card/60 transition-colors">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <CardDescription className="text-xs">
                                        Witnessed by {post.isAiResponse ? <ScingularLogoText className="text-sm" /> : author?.name}
                                    </CardDescription>
                                </div>
                            </div>
                        </CardHeader>
                        ...
                        <CardFooter className="flex items-center gap-4 text-[10px] text-muted-foreground font-mono border-t border-border/50 pt-3 opacity-70">
                            <div className="flex items-center gap-1">
                                <ThumbsUp className="h-3 w-3" /> {post.likes} WITNESS_MARKS
                            </div>
                            <div className="flex items-center gap-1">
                                <MessageCircle className="h-3 w-3" /> {post.comments} RESPONSES
                            </div>
                             <div className="flex items-center gap-1 ml-auto">
                                <Clock className="h-3 w-3" /> PERSISTED
                            </div>
                        </CardFooter>
                    </Card>
                    )
             ...
             <div className="sticky top-24 space-y-6">
                 <Card className="bg-card/40 backdrop-blur-sm border-border/50">
                    <CardContent className="p-4 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <Link href="/profile" className="text-[11px] text-pro hover:underline">Identity Configuration</Link>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-card/40 backdrop-blur-sm border-border/50">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm flex items-center gap-2 opacity-70">
                            <ShieldAlert className="h-4 w-4" /> BANE_ALERTS
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <div className="p-2 border border-pro/10 rounded bg-pro/5 text-[10px] text-muted-foreground">
                            <span className="text-pro font-bold">SYSTEM_NOTE:</span> All social metadata is archived for forensic recall. Direct interaction capability requires LARI-S Tier authorization.
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-card/40 backdrop-blur-sm border-border/50">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm flex items-center gap-2 opacity-70">
                            <Rss className="h-4 w-4" /> Industry Feed
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
