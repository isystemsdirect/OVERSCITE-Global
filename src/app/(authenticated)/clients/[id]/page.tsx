...
export default function ClientProfilePage({ params }: { params: { id: string } }) {
  ...
  const [clientInspections, setClientInspections] = useState<Inspection[]>([]);
  ...
  if (loading) {
    return <div className="flex justify-center p-20 text-muted-foreground">Loading canonical client profile...</div>;
  }
