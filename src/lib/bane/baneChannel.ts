...
export class BaneChannel {
  ...
  private async dispatch<T>(
    ...
    switch (action) {
      ...
      case 'finding.review':
        return this.adapters.finding.review<T>(resource, context, decision);
      case 'finding.ingest':
        return this.adapters.finding.ingest<T>(resource, context, decision);
      case 'report.finalize':
        return this.adapters.report.finalize<T>(resource, context, decision);
      default:
