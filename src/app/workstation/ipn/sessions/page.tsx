...
export default function IPNSessionsPage() {
    return (
             ...
             <header className="flex justify-between items-end border-b border-white/10 pb-4">
                <div className="flex flex-col gap-1">
                    <h1 className="text-xl font-black uppercase text-white tracking-widest flex items-center gap-2">
                        <Network className="text-primary" /> IPN Sessions
                    </h1>
                     <nav className="text-xs text-muted-foreground"><Link href="/workstation/ipn" className="hover:text-white">IPN Home</Link> / Sessions</nav>
                </div>
            </header>
            
            <div className="bg-black/40 border border-white/10 rounded-md p-8 text-center text-muted-foreground">
                No active IPN sessions detected.
            </div>
        </div>
    );
}
