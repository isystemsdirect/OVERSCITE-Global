...
const firebaseConfig = {
  ...
  authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || 'SCINGULAR-global.firebaseapp.com',
  projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || 'SCINGULAR-global',
  storageBucket: process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || 'SCINGULAR-global.appspot.com',
