...
export const CONTRACTS: Record<EngineId, EngineContract> = {
  ...
  'SCING-ORCH': {
    id: 'SCING-ORCH',
    input: ['artifacts', 'telemetry', 'policy'],
    output: ['audit_events'],
    emitsSignals: true,
  },
  'LARI-ORCH': {
  ...
  'LARI-PLANNER': {
    id: 'LARI-PLANNER',
    input: ['intent_vector', 'semantic_map', 'constraint_map', 'artifacts', 'policy'],
    output: ['findings', 'audit_events'],
    emitsSignals: true,
  },
  'LARI-CRITIC': {
    id: 'LARI-CRITIC',
    input: ['findings', 'artifacts', 'policy'],
    output: ['findings', 'audit_events'],
    emitsSignals: true,
  },
  'LARI-SYNTHESIZER': {
    id: 'LARI-SYNTHESIZER',
    input: ['findings', 'artifacts', 'classifications', 'policy'],
    output: ['findings', 'audit_events'],
    emitsSignals: true,
  },
  'LARI-CONTEXT-ENGINE': {
    ...
    input: ['artifacts', 'telemetry', 'policy'],
    output: ['findings', 'classifications', 'audit_events'],
    emitsSignals: true,
  },
  'LARI-ANALYST': {
    id: 'LARI-ANALYST',
    input: ['artifacts', 'telemetry', 'findings', 'policy'],
    output: ['findings', 'audit_events'],
    emitsSignals: true,
  },
  'LARI-RETRIEVER': {
    id: 'LARI-RETRIEVER',
    input: ['intent_vector', 'artifacts', 'policy'],
    output: ['artifacts', 'findings', 'audit_events'],
    emitsSignals: true,
  },
  ...
  'BANE-CORE': {
    id: 'BANE-CORE',
    input: ['intent_vector', 'policy', 'artifacts', 'keys'],
    output: ['policy_flags', 'audit_events'],
    emitsSignals: true,
  },
  'BANE-POLICY': {
    id: 'BANE-POLICY',
    input: ['intent_vector', 'policy', 'keys', 'policy_flags'],
    output: ['policy_flags', 'audit_events'],
    emitsSignals: true,
  },
  'BANE-AUDIT': {
    id: 'BANE-AUDIT',
    input: ['audit_events', 'artifacts', 'policy_flags'],
    output: ['audit_events'],
    emitsSignals: true,
  },
  'BANE-COMPLIANCE': {
    id: 'BANE-COMPLIANCE',
    input: ['policy', 'findings', 'artifacts', 'telemetry'],
    output: ['policy_flags', 'findings', 'audit_events'],
    emitsSignals: true,
  },
  ...
  'LARI-STANDARDS': {
    id: 'LARI-STANDARDS',
    input: ['findings', 'policy', 'artifacts', 'classifications'],
    output: ['findings', 'report_blocks', 'audit_events'],
    emitsSignals: true,
  },
  'SCING-REPORT': {
    id: 'SCING-REPORT',
    input: ['findings', 'classifications', 'artifacts', 'map_layers', 'report_blocks'],
    output: ['report_blocks', 'audit_events'],
    emitsSignals: true,
  },
  'SCING-AUDIT': {
    id: 'SCING-AUDIT',
    input: ['audit_events', 'artifacts', 'policy'],
    output: ['audit_events'],
    emitsSignals: true,
  },
  ...
  'LARI-CONTRACTOR': {
    id: 'LARI-CONTRACTOR',
    input: ['artifacts', 'telemetry', 'findings', 'policy'],
    output: ['findings', 'classifications', 'report_blocks', 'audit_events'],
    emitsSignals: true,
  },
  'LARI-ENGINEER': {
    id: 'LARI-ENGINEER',
