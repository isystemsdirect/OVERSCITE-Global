            ...
            <div className="space-y-12 text-foreground">
                ...
                <header className="space-y-6 text-center">
                    <div className="inline-flex items-center justify-center mb-0">
                        <OversciteLogo className="h-72 w-auto text-[#FFC107] fill-current" style={{ color: '#FFC107' }} />
                    </div>
                    <h1 className="text-4xl font-extrabold tracking-tight lg:text-6xl flex flex-col items-center justify-center gap-2 -mt-12">
                        <span className="text-lg lg:text-xl tracking-[0.5em] font-medium uppercase text-[#FFC107]">G L O B A L</span>
                        <span className="text-2xl text-muted-foreground font-normal mt-2">System Architecture & Feature Report</span>
                    </h1>
                    <p className="text-xl text-muted-foreground max-w-5xl mx-auto leading-relaxed">
                        A definitive technical map of a vertically-integrated inspection ecosystem
                        powered by Augmented Intelligence (AI) under human authority.
                        Unifying <strong>LARI™</strong> (analysis), <strong>Scing™</strong> (human-layer interaction), and <strong>BANE™</strong> (trust enforcement)
                        into a governed operational environment for field inspection work.
                    </p>
                </header>
